...
namespace Chiticariu_Ramona_Georgiana_Lab8.Models
{
    public class BookCategoriesPageModel: PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Chiticariu_Ramona_Georgiana_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Chiticariu_Ramona_Georgiana_Lab8Context context,
